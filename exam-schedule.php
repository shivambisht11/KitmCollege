...
<?php
    ...
    <div class="con-title">
        <h2>Exam <span> Schedule</span></h2>
    </div>

    <!-- Start section -->

    <?php
    $sql = "SELECT * FROM exam_schedule WHERE status='1'";
        ...
        <div class="list-container">
            ...
            ?>
                ...
                margin: 4px 10px 2px 11px;">
                    ...
                    <a href="admin/<?php echo $row['exam_s_file'] ?>" target="_blank" class="list-item-text"><?php echo $row['exam_s_name'] ?></a> </span>
