                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Edit PYQs</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="pyq.php">PYQs</a></li>
                                    <li class="breadcrumb-item active">Edit PYQs</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="card comman-shadow">
                                                <div class="card-body">
                                                    <form>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <h5 class="form-title student-info">Prevoius Year Paper Information
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" value="Bsc IT 2023">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Created By</label>
                                                                    <input type="text" class="form-control" value="KabirSingh">
                                                                </div>
                                                            </div>
