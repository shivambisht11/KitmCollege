...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM sports_activity WHERE s_id = '$id' ");
                ...
                <div class="row">
                    <div class="col-md-9">
                        <ul class="list-links mb-4">
                            <li class="active"><a href="sports-activity.php">Sports</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 text-md-end">
                        <a href="add-s-activity.php" class="btn btn-primary btn-blog mb-3"><i class="feather-plus-circle me-1"></i> Add New</a>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                            $select = "SELECT * FROM sports_activity";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="uploads/sports/<?php echo $row['s_image']; ?>" alt="image" style="height: 100px;"></td>
                                    <td><?php echo $row['created_at']; ?></td>
                                    <td><?php if ($row['status'] == 1) {
                                            echo '<a href="config/status_sports.php?id=' . $row['s_id'] . '&status=0" class="btn btn-success">Active</a>';
                                        } else {
                                            echo '<a href="config/status_sports.php?id=' . $row['s_id'] . '&status=1" class="btn btn-danger">Deactive</a>';
                                        }
                                        ?></td>
                                    <td class="text-end">
                                        <div class="actions">
                                            <a href="sports-activity.php?id=<?php echo $row['s_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                <i class="feather-delete"></i>
                                            </a>
                                            <a href="edit-s-activity.php?id=<?php echo $row['s_id']; ?>" class="btn btn-sm bg-danger-light">
