...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM syllabus WHERE syll_id = '$id' ");
            ...
            <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="syllabus.php">Syllabus</a></li>
                ...
                <!-- <div class="student-group-form">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Search by Deaprtment ...">
                            </div>
                        </div>
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="add-syllabus.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['syll_file']; ?></td>
                                                    <td><?php if ($row['status'] == 1) {
                                                            echo '<a href="config/status_syll.php?id=' . $row['syll_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                                        } else {
                                                            echo '<a href="config/status_syll.php?id=' . $row['syll_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                                        }
                                                        ?></td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="syllabus.php?id=<?php echo $row['syll_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                                <i class="feather-delete"></i>
                                                            </a>
                                                            <a href="edit-syllabus.php?id=<?php echo $row['syll_id']; ?>" class="btn btn-sm bg-danger-light">
