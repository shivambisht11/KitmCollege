...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['new_image']['name'] != '') {
        ...
        // move_uploaded_file($tempname, 'uploads/slider/' . $file_name);
    ...
    $sql = " UPDATE `slider` SET `slider_t1`='$slider_t1',`slider_t2`='$slider_t2',`slider_line`='$slider_line',`slider_image`= '$file_name'  WHERE `slider_id` = '$id' ";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert(" Slider Update sucessfully");</script>';
        echo '<script>window.location.assign("slider.php");</script>';
    } else {
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            ...
                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM slider WHERE slider_id = '$id'";
                                            $result = $conn->query($select_query);

                                            $slider = $result->fetch_assoc();
                                            $slider_t1 =  $slider["slider_t1"];
                                            $slider_t2 =  $slider["slider_t2"];
                                            $slider_line =  $slider["slider_line"];
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="slider_t1" value="<?php echo $slider_t1; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Slider Title 2<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="slider_t2" value="<?php echo $slider_t2; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Slider Line<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="slider_line" value="<?php echo $slider_line; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label> Image <span class="text-danger">(Dimension must be: 1400 X 600)*</span></label>
                                                    <div class="change-photo-btn">

                                                        <input type="file" name="new_image">
                                                        <img src="./uploads/slider/<?php echo $slider_image; ?>" alt="image" height="150px">
                                                        <input type="hidden" name="old_image" value="<?php echo $slider_image; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" blog-categories-btn pt-0">
                                        <div class="bank-details-btn ">
                                            <button type="submit" class="btn bank-cancel-btn me-2" name="update">Edit Post</button>
                                        </div>
                                </form>
                            </div>
                        </div>
