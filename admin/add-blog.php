...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    ...
    $sql = "INSERT INTO blog(`blog_title`,`blog_image`,`blog_description`,`created_at`,`created_by`,`status`) VALUES ('$blog_title','$file_name','$blog_description',current_timestamp(),'$created_by','$status')";
    ...
    if ($result) {
        ...
        echo '<script>window.location.assign("add-blog.php");</script>';
        die();
    } else {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="blog_description" id="blog_description" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
