...
if (isset($_POST["submit"])) {
    ...
    $status = $_POST["status"];
    $sql = "INSERT INTO admit_card(`admit_card_name`, `admit_card_url`,`created_at`,`status`) VALUES ('$admit_card_name','$admit_card_url',current_timestamp(),'$status')";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert("Admit Card Details Added Sucessfully");</script>';
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Add Admit Card</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="admit-card.php">Admit Card</a></li>
                                <li class="breadcrumb-item active">Add Admit Card</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Admit Card Name</label>
                                                <input type="text" class="form-control" name="admit_card_name">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Admit Card Url<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" name="admit_card_url">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
