...
if (isset($_POST["submit"])) {
    ...
    $sl_url = $_POST["sl_url"];
    $status = $_POST["status"];
    $sql = "INSERT INTO scrolling_link(`sl_name`, `sl_url`,`created_at`,`status`) VALUES ('$sl_name','$sl_url',current_timestamp(),'$status')";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert("Scrolling Links Details Added Sucessfully");</script>';
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Add Scrolling Links</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="scrolling.php">Scrolling Links</a></li>
                                <li class="breadcrumb-item active">Add Scrolling Links</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Scrolling Links Name</label>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sl_url">
                                            </div>
                                        </div>
