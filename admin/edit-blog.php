...
if (isset($_POST['update'])) {
    ...
    $sql = " UPDATE `blog` SET `blog_title`='$blog_title',`blog_description`='$blog_description',`blog_image`='$blog_image',`created_at`=current_timestamp(),`created_by`='$created_by',`status`='$status' WHERE `blog_id` = '$id' ";
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="change-photo-btn">
                                                        ...
                                                        <img src="uploads/blog/<?php echo $blog_image; ?>" alt="image" height="150px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="blog_description" id="blog_description" cols="30" rows="10" value="<?php echo $blog_description; ?>"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms ">
                                                    <label>Created By <span class="login-danger">*</span></label>
                                                    <input class="form-control " type="text" name="created_by" value="<?php echo $created_by; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
