...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM exam_form WHERE exam_id = '$id' ");
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2>
                                                            <a><?php echo $row['exam_name']; ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo $row['exam_url']; ?></td>
                                                    <td><?php echo $row['created_at']; ?></td>
                                                    <td><?php if ($row['status'] == 1) {
                                                            echo '<a href="config/status_exam.php?id=' . $row['exam_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                                        } else {
                                                            echo '<a href="config/status_exam.php?id=' . $row['exam_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                                        }
                                                        ?></td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="exam.php?id=<?php echo $row['exam_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                                <i class="feather-delete"></i>
                                                            </a>
                                                            <a href="edit-exam.php?id=<?php echo $row['exam_id']; ?>" class="btn btn-sm bg-danger-light">
