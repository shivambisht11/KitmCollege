...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    ...
    $sql = "INSERT INTO testimonials(`t_name`,`t_desgination`,`t_msg`,`t_image`,`status`,`created_at`) VALUES ('$t_name','$t_desgination','$t_msg','$file_name','$status',current_timestamp())";

    $result = $conn->query($sql);
    if ($result) {
        $_SESSION['MSG'] = '';
        echo '<script>alert("Testimonial Added Sucessfully");</script>';
        echo '<script>window.location.assign("add-testimonials.php");</script>';
        die();
    } else {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="t_desgination">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Message<span class="text-danger">*</span></label>
                                                    <textarea name="t_msg" id="" cols="30" rows="10" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
