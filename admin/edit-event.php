            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Edit News & Event</h3>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" value="farewell 2024">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group local-forms ">
                                                ...
                                                <input class="form-control " type="text" value="kisi ne paise hi zamma nhi kre">
                                            </div>
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms ">
                                                    <label>Created By <span class="login-danger">*</span></label>
                                                    <input class="form-control " type="text" value="kabir singh">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms ">
                                                ...
                                                <input class="form-control " type="text" value="active">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
