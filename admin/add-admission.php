...
if (isset($_POST["submit"])) {
    ...
    $a_link = $_POST["a_link"];
    $status = $_POST["status"];
    $sql = "INSERT INTO admission(`a_name`, `a_link`,`created_at`,`status`) VALUES ('$a_name','$a_link',current_timestamp(),'$status')";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert("Admission Details Added Sucessfully");</script>';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="a_link">
                                            </div>
                                        </div>
