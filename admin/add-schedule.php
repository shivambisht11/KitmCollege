                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Schedule Exam</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <!-- form starts... -->
                                <form action="savedata_s_exam.php" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Exam Schedule Title<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="exam_s_name">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="change-photo-btn">
                                                        <input type="file" name="exam_s_file">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" blog-categories-btn pt-0">
                                                <div class="bank-details-btn ">
                                                    <button type="submit" class="btn bank-cancel-btn me-2" name="submit">Schedule</button>
                                                </div>
                                </form>
                            </div>
                        </div>
