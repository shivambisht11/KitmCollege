...
if (isset($_POST['update'])) {
    ...
    $sql = " UPDATE `scrolling_link` SET `sl_name`='$sl_name',`sl_url`='$sl_url',`created_at`=current_timestamp(),`status`='$status' WHERE `sl_id` = '$id' ";

    $result = $conn->query($sql);

    if ($result) {
        echo '<script>alert("Update sucessfully");</script>';
        echo '<script>window.location.assign("scrolling.php");</script>';
    } else {
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="scrolling.php">Scrolling Links</a></li>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Edit Scrolling Links</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="scrolling.php">Scrolling Links</a></li>
                                <li class="breadcrumb-item active">Edit Scrolling Links</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Scrolling Links Information</span></h5>
                                            <?php

                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM scrolling_link WHERE sl_id = '$id'";
                                            $result = $conn->query($select_query);

                                            $admitcard = $result->fetch_assoc();

                                            $sl_name =  $admitcard["sl_name"];
                                            $sl_url =  $admitcard["sl_url"];
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Scrolling Links Name <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo $sl_name; ?>" name="sl_name">

                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Scrolling Links Url <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo $sl_url; ?>" name="sl_url">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
