                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Previous Year Papers </h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="pyq.php">PYQs</a></li>
                                    <li class="breadcrumb-item active">All PYQs</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Prevoius Year Papers</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="pyq.php" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                            <!-- <a href="#" class="btn btn-outline-primary me-2"><i
                                                    class="fas fa-download"></i> Download</a> -->
                                            <a href="add-pyq.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions ">
                                                        ...
                                                        <a href="edit-syllabus.php" class="btn btn-sm bg-danger-light">
