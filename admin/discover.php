...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM discover_more WHERE d_id = '$id' ");
...
<head>
    ...
    <title> KITM - Discover More</title>
                ...
                <div class="table-responsive">
                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                            $select = "SELECT * FROM discover_more";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="uploads/discover/<?php echo $row['d_image']; ?>" alt="image" style="height: 100px;"></td>
                                    <td><?php echo $row['d_link']; ?></td>
                                    <td><?php if ($row['status'] == 1) {
                                            echo '<a href="config/status_d.php?id=' . $row['d_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                        } else {
                                            echo '<a href="config/status_d.php?id=' . $row['d_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                        }
                                        ?></td>
                                    <td class="text-end">
                                        <div class="actions">
                                            <a href="discover.php?id=<?php echo $row['d_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                <i class="feather-delete"></i>
                                            </a>
                                            <a href="edit-discover.php?id=<?php echo $row['d_id']; ?>" class="btn btn-sm bg-danger-light">
