...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM blog WHERE blog_id = '$id' ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($row['status'] == 1) {
                                            echo '<a href="config/status_blog.php?id=' . $row['blog_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                        } else {
                                            echo '<a href="config/status_blog.php?id=' . $row['blog_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                        }
                                        ?></td>
                                    <td class="text-end">
                                        <div class="actions">
                                            <a href="blog.php?id=<?php echo $row['blog_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                <i class="feather-delete"></i>
                                            </a>
                                            <a href="edit-blog.php?id=<?php echo $row['blog_id']; ?>" class="btn btn-sm bg-danger-light">
