...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['new_image']['name'] != '') {
        ...
        if (empty($errors) == true) {
            move_uploaded_file($file_tmp, "uploads/discover/" . $file_name);
        } else {
            print_r($errors);
            die();
        }
    ...
    $sql = " UPDATE `discover_more` SET `d_name`='$d_name',`d_link`='$d_link',`d_image`= '$file_name'  WHERE `d_id` = '$id' ";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert(" Disover Updated sucessfully");</script>';
        echo '<script>window.location.assign("discover.php");</script>';
    } else {
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="discover.php">Discover More</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Edit Discover Section</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            ...
                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM discover_more WHERE d_id = '$id'";
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="d_link" value="<?php echo $d_link; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label> Image <span class="text-danger">(Dimension: 500 x 300)*</span></label>
                                                    <div class="change-photo-btn">
                                                        <input type="file" name="new_image">
                                                        <img src="./uploads/discover/<?php echo $d_image; ?>" alt="image" height="150px">
                                                        <input type="hidden" name="old_image" value="<?php echo $d_image; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
