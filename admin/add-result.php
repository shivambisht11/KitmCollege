...
if (isset($_POST["submit"])) {
    ...
    $status = $_POST["status"];
    $sql = "INSERT INTO result(`result_name`, `result_url`,`created_at`,`status`) VALUES ('$result_name','$result_url',current_timestamp(),'$status')";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert("Result Details Added Sucessfully");</script>';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="result_name">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Result Url<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" name="result_url">
                                            </div>
                                        </div>
