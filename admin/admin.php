...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM admin WHERE admin_id = '$id' ");
...
<head>
    ...
    <title>Kitm - All Users Table</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="admin.php?id=<?php echo $row['admin_id']; ?>" class="btn btn-sm bg-success-light me-2">
