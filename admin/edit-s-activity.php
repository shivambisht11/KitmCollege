...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `sports_activity` SET `s_title`='$s_title',`s_description`=' $s_description',`s_image`='$file_name',`created_at`=current_timestamp() WHERE `s_id` = '$id'";

    $result = $conn->query($sql);

    if ($result) {
        echo '<script>alert(" Sports Activity Update sucessfully");</script>';
        echo '<script>window.location.assign("sports-activity.php");</script>';
    } else {
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Edit Sports Activity</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            ...
                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM sports_activity WHERE s_id = '$id'";
                                            $result = $conn->query($select_query);

                                            $sports = $result->fetch_assoc();

                                            $s_title = $sports["s_title"];
                                            $s_description = $sports["s_description"];
                                            $s_image =  $sports["s_image"];

                                            ?>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Title<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="s_title" value="<?php echo $s_title; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Description<span class="text-danger">*</span></label>
                                                    <textarea name="s_description" id="" cols="40" rows="10" class="form-control">  <?php echo $s_description; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label> Image <span class="text-danger">(Dimension: 1600 x 900)*</span></label>
                                                    <div class="change-photo-btn">
                                                        <input type="file" name="new_image">
                                                        <img src="./uploads/sports/<?php echo $s_image; ?>" alt="image" height="150px">
                                                        <input type="hidden" name="old_image" value="<?php echo $s_image; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
