...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM contact_us WHERE contact_id = '$id' ");
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <!-- <a href="add-contact.php" class="btn btn-primary"><i class="fas fa-plus"></i></a> -->
                                        </div>
                                    </div>
                                </div>
                                <?php
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['contact_sub'] ?></td>
                                                        <td><?php echo $row['contact_msg'] ?></td>
                                                        <td><?php echo $row['created_at'] ?></td>
                                                        <td class="text-end">
                                                            <div class="actions">
                                                                <a href="contact.php?id=<?php echo $row['contact_id']; ?>" class="btn btn-sm bg-danger-light ">
                                                                    <i class="fa fa-trash" aria-hidden="true"></i>
                                                                </a>
                                                                <!-- <a href="edit-contact.php?id=<?php echo $row['contact_id']; ?>" class="btn btn-sm bg-danger-light">
