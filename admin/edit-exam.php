...
if (isset($_POST['update'])) {
    ...
    $sql = " UPDATE `exam_form` SET `exam_name`='$exam_name',`exam_url`='$exam_url',`created_at`=current_timestamp(),`status`='$status' WHERE `exam_id` = '$id' ";
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="exam.php">Exam Form</a></li>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Edit Exam Form</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="exam.php">Exam Links</a></li>
                                <li class="breadcrumb-item active">Edit exam Links</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Exam Links Information</span></h5>
                                            <?php
                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM exam_form WHERE exam_id = '$id'";
                                            $result = $conn->query($select_query);

                                            $admitcard = $result->fetch_assoc();

                                            $exam_name =  $admitcard["exam_name"];
                                            $exam_url =  $admitcard["exam_url"];
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>exam Links Name <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo $exam_name; ?>" name="exam_name">

                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>exam Links Url <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="<?php echo $exam_url; ?>" name="exam_url">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
