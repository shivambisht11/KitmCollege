...
if (isset($_POST["submit"])) {
    ...
    $status = $_POST["status"];
    $sql = "INSERT INTO exam_form(`exam_name`, `exam_url`,`created_at`,`status`) VALUES ('$exam_name','$exam_url',current_timestamp(),'$status')";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert("Exam Form Details Added Sucessfully");</script>';
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="scrolling.php">Exam Form</a></li>
                                <li class="breadcrumb-item active">Add Exam Form</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title"><span>Exam Form Information</span></h5>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Exam Form Name</label>
                                                <input type="text" class="form-control" name="exam_name">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Exam Form Url<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" name="exam_url">
                                            </div>
                                        </div>
