...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM admission WHERE a_id = '$id' ");
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="add-admission.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2>
                                                            <a><?php echo $row['a_name']; ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo $row['a_link']; ?></td>
                                                    <td><?php echo $row['created_at']; ?></td>
                                                    <td><?php if ($row['status'] == 1) {
                                                            echo '<a href="config/status_a.php?id=' . $row['a_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                                        } else {
                                                            echo '<a href="config/status_a.php?id=' . $row['a_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                                        }
                                                        ?></td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="admission.php?id=<?php echo $row['a_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                                <i class="feather-delete"></i>
                                                            </a>
                                                            <a href="edit-admission.php?id=<?php echo $row['a_id']; ?>" class="btn btn-sm bg-danger-light">
