                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <!-- form starts... -->
                                <form action="savedata_s_syllabus.php" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Syllabus Title<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="syll_name">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="change-photo-btn">
                                                        <input type="file" name="syll_file">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" blog-categories-btn pt-0">
                                                <div class="bank-details-btn ">
                                                    <button type="submit" class="btn bank-cancel-btn me-2" name="submit">Add</button>
                                                </div>
                                </form>
                            </div>
                        </div>
