...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['new_image']['name'] != '') {
        ...
        if (empty($errors) == true) {
            move_uploaded_file($file_tmp, "uploads/governing/" . $file_name);
        } else {
            print_r($errors);
            die();
        }
    ...
    $sql = " UPDATE `governing` SET `g_name`='$g_name',`time_period`='$time_period',`g_image`= '$file_name'  WHERE `g_id` = '$id' ";

    $result = $conn->query($sql);
    if ($result) {
        echo '<script>alert(" Governing Update sucessfully");</script>';
        echo '<script>window.location.assign("governing.php");</script>';
    } else {
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Edit Governing Bodies</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="bank-inner-details">
                                        <div class="row">
                                            ...
                                            $id = $_GET['id'];
                                            $select_query = "SELECT * FROM governing WHERE g_id = '$id'";
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label>Time Period<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="time_period" value="<?php echo $time_period; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <label> Image <span class="text-danger">(Dimension: 1024 x 1280)*</span></label>
                                                    <div class="change-photo-btn">

                                                        <input type="file" name="new_image">
                                                        <img src="./uploads/governing/<?php echo $g_image; ?>" alt="image" height="150px">
                                                        <input type="hidden" name="old_image" value="<?php echo $g_image; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
