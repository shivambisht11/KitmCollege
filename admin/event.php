                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="event.php">News & Events</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">News & Event</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="event.php" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions ">
                                                        ...
                                                        <a href="edit-event.php" class="btn btn-sm bg-danger-light">
