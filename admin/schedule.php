...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM exam_schedule WHERE exam_s_id = '$id' ");
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                <li class="active"><a href="schedule.php">Exam Schedule</a></li>
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="add-schedule.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2>
                                                            <a><?php echo $row['exam_s_name']; ?></a>
                                                        </h2>
                                                    </td>
                                                    <td><?php echo $row['exam_s_file']; ?></td>
                                                    <td><?php echo $row['created_at']; ?></td>
                                                    <td><?php if ($row['status'] == 1) {
                                                            echo '<a href="config/status_s_exam.php?id=' . $row['exam_s_id'] . '&status=0" class="btn btn-success status">Active</a>';
                                                        } else {
                                                            echo '<a href="config/status_s_exam.php?id=' . $row['exam_s_id'] . '&status=1" class="btn btn-danger status">Deactive</a>';
                                                        }
                                                        ?></td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="schedule.php?id=<?php echo $row['exam_s_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                                <i class="feather-delete"></i>
                                                            </a>
                                                            <!-- <a href="edit-schedule.php?id=<?php echo $row['exam_s_id']; ?>" class="btn btn-sm bg-danger-light">
