...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($conn, "DELETE FROM scrolling_link WHERE sl_id = '$id' ");
...
<head>
    ...
    <title>KITM - Scrolling Links</title>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Scrolling Links</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Scrolling Links</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            ...
                                            <a href="add-scrolling.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        <thead class="student-thread">
                                            <tr>
                                                <th>Scrolling Links id</th>
                                                <th>Scrolling Links Name</th>
                                                <th>Scrolling Links Url</th>
                                                <th>Created At</th>
                                                <th>Status</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $select = "SELECT * FROM scrolling_link";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['sl_url']; ?></td>
                                                    <td><?php echo $row['created_at']; ?></td>
                                                    <td><?php if ($row['status'] == 1) {
                                                            echo '<a href="config/status_s.php?id=' . $row['sl_id'] . '&status=0" class="btn btn-success">Active</a>';
                                                        } else {
                                                            echo '<a href="config/status_s.php?id=' . $row['sl_id'] . '&status=1" class="btn btn-danger">Deactive</a>';
                                                        }
                                                        ?></td>
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="scrolling.php?id=<?php echo $row['sl_id']; ?>" class="btn btn-sm bg-success-light me-2">
                                                                <i class="feather-delete"></i>
                                                            </a>
                                                            <a href="edit-scrolling.php?id=<?php echo $row['sl_id']; ?>" class="btn btn-sm bg-danger-light">
